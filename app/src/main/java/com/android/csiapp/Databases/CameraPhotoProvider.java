 ...
 */
public class CameraPhotoProvider {
    // 表格名稱
    public static final String TABLE_NAME = "camera_photo";
    ...
    public static final String CREATE_TABLE =
            "CREATE TABLE " + TABLE_NAME + " (" +
                    ...
                    PHOTO_INFO_COLUMN + " TEXT NOT NULL)";

    // 資料庫物件
    private SQLiteDatabase db;

    // 建構子，一般的應用都不需要修改
    public CameraPhotoProvider(Context context) {
