 ...
 */
public class PositionPhotoProvider {
    // 表格名稱
    public static final String TABLE_NAME = "position_photo";
    ...
    public static final String PHOTO_INFO_COLOUM = "photo_info";
    ...
    public static final String CREATE_TABLE =
            "CREATE TABLE " + TABLE_NAME + " (" +
                    ...
                    PHOTO_INFO_COLOUM + " TEXT NOT NULL)";

    // 資料庫物件
    private SQLiteDatabase db;

    // 建構子，一般的應用都不需要修改
    public PositionPhotoProvider(Context context) {
    ...
    public long insert(PhotoItem item) {
        ...
        cv.put(PHOTO_INFO_COLOUM, item.getPhotoInfo());
