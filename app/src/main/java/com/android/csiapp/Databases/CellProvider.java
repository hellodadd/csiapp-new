...
public class CellProvider {
    // 表格名稱
    public static final String TABLE_NAME = "cell_result";
    ...
    public static final String CELL_PATH_COLUMN = "cell_path";
    ...
    public static final String CREATE_TABLE =
            "CREATE TABLE " + TABLE_NAME + " (" +
                    ...
                    CELL_PATH_COLUMN + " TEXT NOT NULL)";

    // 資料庫物件
    private SQLiteDatabase db;

    // 建構子，一般的應用都不需要修改
    public CellProvider(Context context) {
    ...
    public long insert(PhotoItem item) {
        ...
        cv.put(CELL_PATH_COLUMN, item.getPhotoPath());
