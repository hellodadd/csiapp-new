 ...
 */
public class ImportantPhotoProvider {
    // 表格名稱
    public static final String TABLE_NAME = "important_photo";
    ...
    public static final String PHOTO_INFO_COLLUM = "photo_info";
    ...
    public static final String CREATE_TABLE =
            "CREATE TABLE " + TABLE_NAME + " (" +
                    ...
                    PHOTO_INFO_COLLUM + " TEXT NOT NULL)";

    // 資料庫物件
    private SQLiteDatabase db;

    // 建構子，一般的應用都不需要修改
    public ImportantPhotoProvider(Context context) {
    ...
    public long insert(PhotoItem item) {
        ...
        cv.put(PHOTO_INFO_COLLUM, item.getPhotoInfo());
