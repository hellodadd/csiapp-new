...
public class SettingActivityNew extends AppCompatActivity {
    ...
    LauncherPreference backup;
    LauncherPreference deviceinit;
    LauncherPreference recovery;
    LauncherPreference update;
    ...
    private void setupView(){
        ...
        backup = (LauncherPreference)findViewById(R.id.backup);
        backup.setOnClickListener(btnBackupOnClick);
        deviceinit = (LauncherPreference)findViewById(R.id.deviceinit);
        deviceinit.setOnClickListener(btnDeviceInitialOnClick);
        recovery = (LauncherPreference)findViewById(R.id.recovery);
        recovery.setOnClickListener(btnRestoreOnClick);
        update = (LauncherPreference)findViewById(R.id.update);
        update.setOnClickListener(btnAppUpdateOnClick);
    ...
    private View.OnClickListener btnBackupOnClick = new View.OnClickListener () {
        ...
        public void onClick(View view) {
            ...
            mBuilder = new AlertDialog.Builder(SettingActivityNew.this);
    ...
    private View.OnClickListener btnRestoreOnClick = new View.OnClickListener () {
        @Override
        public void onClick(View view) {
            RestoreListDialog restoreListDialog = new RestoreListDialog(SettingActivityNew.this);
